...
const ForgotPasswordModal = ({ onClose }) => {
  ...
  const handleSend = async (e) => {
    ...
    setSending(true)
    try {
      // Replace this URL with your actual forgot-password API endpoint
  ...
  return (
    <div className="fp-overlay" onClick={handleOverlayClick}>
      <div className="fp-modal">
        <button className="fp-close" onClick={onClose} aria-label="Close"><IconX /></button>
        ...
        {step === 'email' ? (
          <>
            ...
            <div style={{ width:52, height:52, borderRadius:16,
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <circle cx="12" cy="14.5" r="0.5" fill="#2563eb"/>
              </svg>
            </div>
            ...
            <p style={{ fontSize:13.5, color:'#64748b', lineHeight:1.65, margin:'0 0 24px' }}>
            ...
            <form onSubmit={handleSend}>
              ...
              {error && (
                <p style={{ fontSize:12.5, color:'#dc2626', margin:'0 0 14px',
              ...
              <button type="submit" className="lw-btn" disabled={sending}>
                {sending ? 'Sending…' : <><span>Send Reset Link</span><IconArrow /></>}
              </button>
            </form>

            <p style={{ textAlign:'center', fontSize:12.5, color:'#94a3b8', margin:'16px 0 0' }}>
              Remembered it?{' '}
          ...
          /* ── Success state ── */
          <>
            <button className="fp-back" onClick={() => setStep('email')}>
              <IconBack /> Back
            </button>
            ...
            <div style={{ textAlign:'center' }}>
              ...
              <p style={{ fontSize:13.5, color:'#64748b', lineHeight:1.7, margin:'0 0 6px' }}>
                We've sent a password reset link to
              </p>
              <p style={{ fontSize:14, fontWeight:700, color:'#2563eb', margin:'0 0 24px',
                wordBreak:'break-all' }}>
                {fpEmail}
              </p>
              <p style={{ fontSize:12.5, color:'#94a3b8', lineHeight:1.6, margin:'0 0 24px' }}>
              ...
              <button className="lw-btn" onClick={onClose}>
                Back to Sign In
              </button>
            </div>
          </>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom:8 }}>
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:7 }}>
                ...
                {/* ✅ FIX: onClick now opens the forgot password modal */}
                <span
