...
const S = `
  ...
  .btn-approve:hover:not(:disabled) { transform:translateY(-1px); box-shadow:0 6px 20px rgba(22,163,74,0.4); }
  ...
  /* ── Chat ── */
  .pw-chat-wrap { position:sticky; top:88px; }
  ...
  .pw-msg-time { font-size:10px; margin-top:3px; opacity:0.65; }
  ...
  .pw-timeline-item:not(:last-child)::before {
    content:''; position:absolute;
    left:4px; top:22px; bottom:-10px;
...
const ProjectWorking = () => {
  ...
  if (!project) return (
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center',
      ...
      <span style={{ fontSize:13, color:'#94a3b8', fontFamily:'Plus Jakarta Sans,sans-serif', fontWeight:600 }}>
        Loading project…
      </span>
  ...
  const msgCount    = chats?.messages?.length || 0
    ...
    <div className="pw pw-page">
      ...
      <div className="pw-layout">
        ...
        <div>
              ...
              {project.skills?.length > 0 && (
                <div style={{ display:'flex', flexWrap:'wrap', marginBottom:16 }}>
                  {project.skills.map(s => (
                    <span key={s} className="pw-skill">{s}</span>
                  ))}
                </div>
              )}
                ...
                {project.createdAt && (
                  <div style={{ display:'flex', alignItems:'center', gap:8,
                    ...
                    <span style={{ fontSize:13, fontWeight:600, color:'#64748b' }}>
                      Posted {fmtDate(project.createdAt)}
                    </span>
                  </div>
                )}
              </div>
            ...
            <div className="pw-card" style={{ animationDelay:'0.07s' }}>
              ...
              <div className="pw-card-body">
                ...
                <div style={{ display:'flex', alignItems:'center', gap:6,
                  ...
                  <Icon d={icons.star} size={12} color="#94a3b8"/>
            ...
            <div className="pw-card" style={{ animationDelay:'0.14s' }}>
              <div className="pw-card-head">
                ...
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ fontSize:13, fontWeight:600, color:'#0f172a' }}>
                    {project.submission ? 'Work submitted for review' : 'Awaiting submission'}
                  </div>
                </div>
                {project.submission && !project.submissionAccepted && (
                  <span style={{ background:'#fffbeb', color:'#d97706',
                    border:'1px solid #fde68a', padding:'4px 10px',
                    ...
                    {project.submissionAccepted ? (
                      ...
                      <>
                        <p style={{ fontSize:13, color:'#64748b', marginBottom:14,
                          ...
                          ⚠️ Please review the submitted work before approving or requesting changes.
                        </p>
          ...
          {!project.freelancerId && (
            <div className="pw-card" style={{ animationDelay:'0.07s' }}>
              <div className="pw-card-body" style={{ textAlign:'center', padding:'40px 24px' }}>
                <div style={{ fontSize:40, marginBottom:12 }}>🔍</div>
                <div style={{ fontSize:15, fontWeight:700, color:'#0f172a', marginBottom:6 }}>
                  Waiting for Freelancers
                </div>
                <div style={{ fontSize:13, color:'#94a3b8', lineHeight:1.6, marginBottom:16 }}>
                  No freelancer has been assigned yet. Once you approve an application, they'll appear here.
                </div>
                <button
                ...
                >
                  <Icon d={icons.eye} size={14} color="white"/>
                  View Applications
                </button>
              </div>
            </div>
          ...
          <div className="pw-card" style={{ marginBottom:0 }}>
            <div className="pw-card-head">
              ...
              <div style={{ flex:1 }}>
                ...
                <div style={{ fontSize:13, fontWeight:600, color:'#0f172a' }}>
                  {project.freelancerName || (project.freelancerId ? 'Freelancer' : 'Locked')}
                </div>
              </div>
              {project.freelancerId && (
                      ...
                      {[1,2,3].map(i => (
                        <div key={i} style={{ display:'flex',
                          ...
                          <div className="skeleton"
                            style={{ height:38, width:`${50 + i*10}%`, borderRadius:16 }}/>
                        </div>
                      ))}
                    </div>
